...
// apartmentRouter.route('/users')
//     .get(cors.corsWithOptions, authenticate.verifyUser, (req, res, next) => {
//         res.json(req.user);
//     })

apartmentRouter.route('/users/:userId')
    .put(cors.corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin, (req, res, next) => { 
        Apartments.find({users: req.params.userId}, (err, doc) => {
            
            doc.forEach(d => {
                d.users = d.users.filter(userId => userId !== req.params.userId)});
                console.log(d.users);
            // doc.users = users;
            // doc.save();
